...
define('DOMAIN_URL', 'http://localhost/marvel_admin/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "thetricu_m1";  // Change as required
    private $db_pass = "VRTechie@123";  // Change as required
    private $db_name = "thetricu_m1";    // Change as required
